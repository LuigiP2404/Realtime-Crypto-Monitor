...
export function connectToSocket({ symbol, interval, onCandle, onError, onClose }: { symbol: string, interval: Interval, onCandle: (candle :Candle) => void, onError?: () => void, onClose?: () => void}): () => void {
